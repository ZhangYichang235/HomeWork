...
class APP:
    ...
    def __init__(self, width=500, height=300):
        ...
        tfsjkk = tk.Radiobutton(frame_1, text='第二通道(备用)', variable=self.v, value=0, width=16, height=3)
    ...
    def video_play(self,):
            # 视频解析网站地址
            port1 = 'https://okjx.cc/?url='
            port2 = 'https://jx.idc126.net/jx/?url='
            if self.v.get() == 1:
